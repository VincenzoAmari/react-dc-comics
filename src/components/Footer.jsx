...
function Footer() {
    return (
        <footer>
            <div className="container-fluid bg-dark text-white" style={{backgroundImage: 'url(src/assets/img/footer-bg.jpg)', backgroundSize: 'cover', backgroundPosition: 'center', paddingBottom: '100px'}}>
            ...
            <div className="container-fluid bg-dark text-white py-3" style={{position: 'relative', zIndex: 1}}>
                ...
                <div className="follow-us text-primary d-flex align-items-center">
                    ...
                    <a href="#"><img src="src/assets/img/footer-periscope.png" alt="Instagram" className="img-fluid mx-1" style={{height: '20px'}} /></a>
                    </div>
                </div>
                </div>
            </div>
